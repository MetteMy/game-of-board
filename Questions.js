let eGQ = [];
let eGA = [];
//we made different difficulties, but we do not have enough time left
//to implement them, so we will be using them all but have no way to choose difficulty
...
var eGeographyA = ["Stockholm", "Oslo", "Russia", "Denmark", "Berlin", "France", "Belgium", "Greece", "Denmark", "China", "Vanuatu, Venezuela or Vietnam", "Canada", "Helsinki", "Malaysia", "Madrid", "Nepal, Portugal, Senegal, Brazil or Israel", "Denmark", "Belgium, United Kingdom or Vietnam", "Ottawa", "Cairo", "195", "Russia (with 16)", "Canberra", "France, Austria, Turkey, Serbia, Tanzania or Zambia", "27", "Vatican City", "New Zealand", "Canada", "Vatican City (about 800 people)", "Togo"];
...
var ePopcultureQ = ["What does Hakuna Matata mean?", "What movie in 2019 topped Avatar as the highest-grossing film of all time?", "Which tech entrepreneur wanted to name his son X Æ A-12?", "Which country is ABBA from?", "Who has the hit singles “Perfect” and “Shape of You”?", "Who were the lead actors in the movie Twilight?", "Which movies is the line “Life is like a box of chocolate” from?", "What famous Christmas song is Mariah Carey known for?", "Name Donald Duck's three nephews", "When will Queen Elizabeth II die?", "What is the name of Ariel and Prince Eric’s daughter?", "Which Disney Princess sings “Once Upon a Dream”?", "How many Star Wars movies are there (not including spin-offs like Rogue One: A Star Wars Story and Solo)?", "Who was the drummer for The Beatles?", "How many movies are there in the film series The Godfather?", "How many movies has Tom Hanks been in?", "How many ghosts are there in A Christmas Carol?", "What is Tim Burton’s 1993 famous Christmas movie?", "What company has used Santa Claus in its advertisements every year since 1931?", "Black Panther starred which famous actor?", "What is the real name of Joe Exotic (Tiger King)?", "How many kids does Angelina Jolie have?", "What year did Disneyland open?", "What is the name of Wendy’s dog in Peter Pan?", "How many brothers does Prince Hans of the Southern Isles have in Frozen?", "What was the first music video played on MTV?", "What was Freddie Mercury’s real name?", "Which movie (adjusted for inflation) is the highest-grossing movie to date?", "What was the first Pixar movie", "What year was Britney Spears’ album Oops!… I Did It Again released?"];
var ePopcultureA = ["No worries", "Avengers: Endgame", "Elon Musk", "Sweden", "Ed Sheeran", "Robert Pattinson and Kristen Stewart", "Forrest Gump", "All I Want for Christmas Is You", "Louie, Dewey, and Huey", "Never (she's obviously immortal)", "Princess Melody", "Aurora (Sleeping Beauty)", "9", "Ringo Starr", "3", "More than 72", "Four (Christmas Past, Christmas Present, Christmas Future & Jacob Marley)", "The Nightmare Before Christmas", "Coca-Cola", "Chadwick Boseman", "Joseph Allen Maldonado-Passage", "6", "1955", "Nana", "12", "Video Killed the Radio Star", "Frederick Bulsara", "Gone with the Wind", "Toy Story", "2000"];
